...
public class AppManager{
	...
	public static var mainPannel:GraphApp;
	
	public static function init(parent:MovieClip, _width:int, _height:int):void{
		width = _width;
		height = _height;
		mainPannel = new GraphApp(parent, (maxX-_width)/2, (maxY-_height)/2, _width, _height);
		mainPannel.draw();
	...
	public static function addFunction(mathml:String):void {
		mainPannel.addFunction(mathml);
	}	
